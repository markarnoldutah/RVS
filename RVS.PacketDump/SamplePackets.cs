...
internal static class SamplePackets
{
    ...
    public static ServicePacket Full() => new()
    {
        ...
        PasteBlock =
            ...
            + "COMPLAINT: Onan generator runs ~10 min then shuts off, hot smell, ~30 min before restart.\n"
            + "STATUS: https://status.rvserviceflow.com/s/abc123\n"
            + "REF: A1B2C3D4\n"
            + "---------------------------",
        StatusLink = new PacketStatusLink { Url = "https://status.rvserviceflow.com/s/abc123" },
    };
