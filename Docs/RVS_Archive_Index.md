...
| `ARCHIVE/ASOT/RVS_Implementation_Plan_v2.md` | 25-sprint map, runway math, hire plan, risk register. | The risk register, or the hire plan if there is ever a hire. **Not the financial model** — §7 priced the four-tier product and was superseded September 7, 2026 by `RVS_Money.md`. The sprint map is obsolete. |
...
*Prior document set archived September 4, 2026. Superseded by `RVS_Overview.md`, `RVS_Spec.md`, `RVS_Plan.md`, `RVS_Money.md` and this file, plus the five technical documents in `ASOT/`.*
